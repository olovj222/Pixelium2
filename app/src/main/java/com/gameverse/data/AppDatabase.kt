...
private class DatabaseCallback(private val context: Context) : RoomDatabase.Callback() {
    ...
    suspend fun prePopulateProducts(dao: ProductDao) {
        val products = listOf(
            Product(id = 1, name = "Controlador Inalámbrico Élite", details = "Controlador de alto rendimiento para gaming competitivo.", price = 99.99, imageUrl = "https://images.unsplash.com/photo-1542751371-adc38448a05e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDEwfHxnYW1pbmclMjBjb250cm9sbGVyfGVufDB8fHx8MTY3OTM2ODU2Nw&ixlib=rb-4.0.3&q=80&w=600"),
            Product(id = 2, name = "Auriculares Gaming 7.1", details = "Sonido envolvente para una inmersión total.", price = 79.50, imageUrl = "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDF8fGdhbWluZyUyMGhlYWRzZXR8ZW58MHx8fHwxNjc5MzY4NjE0&ixlib=rb-4.0.3&q=80&w=600"),
            Product(id = 3, name = "Teclado Mecánico RGB", details = "Respuesta táctil y retroiluminación personalizable.", price = 120.00, imageUrl = "https://images.unsplash.com/photo-1563297007-0686b7003af7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDEyfHxtZWNoYW5pY2FsJTIwa2V5Ym9hcmR8ZW58MHx8fHwxNjc5MzY4NjQz&ixlib=rb-4.0.3&q=80&w=600"),
            Product(id = 4, name = "Mouse Gamer Programable", details = "Sensor de alta precisión y botones configurables.", price = 45.99, imageUrl = "https://images.unsplash.com/photo-1629429408209-1f912261dbd9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDE1fHxnYW1pbmclMjBtb3VzZXxlbnwwfHx8fDE2NzkzYzgxNDQ&ixlib=rb-4.0.3&q=80&w=600"),
            Product(id = 5, name = "Silla Gamer Ergonómica", details = "Soporte lumbar y diseño de carreras.", price = 189.99, imageUrl = "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDF8fGdhbWluZyUyMGNoYWlyfGVufDB8fHx8MTY3OTM2ODcwMA&ixlib=rb-4.0.3&q=80&w=600"),
            Product(id = 6, name = "Webcam Pro 4K", details = "Videollamadas y streaming en ultra alta definición.", price = 130.00, imageUrl = "https://images.unsplash.com/photo-1616348496622-13361a2936a7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDI0fHxwYyUyMHdlYmNhbXxlbnwwfHx8fDE2NzkzYzgxMTM&ixlib=rb-4.0.3&q=80&w=600")
        )
